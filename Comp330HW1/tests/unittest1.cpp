...
//*TAKEN FROM UNIT TEST PROJECT FOR THIS PROJECT*//
...
//*UNIT TEST TO CHECK IF KWD AND MENTION ARE WORKING CORRECTLY (not exactly the same)*//
...
{		
	...
	public:
		...
		TEST_METHOD(search)
		{
			...
			Assert::AreNotSame(keyword, mention);
